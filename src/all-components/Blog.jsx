...
const Blog = () => {
    const title = "Latest ";
    const highlight = "Blogs";
    const des = "Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut.";
                ...
                <div className="row">
                    <div className="col-sm-12">
                        <div className="blog-section">
                            ...
                            >
                                {sliderArr.map(({ imageClass }, index) => (
                                    <SwiperSlide key={index}>
                                        <div className="blog-post">
                                            <div className={`blog-image ${imageClass}`}>
